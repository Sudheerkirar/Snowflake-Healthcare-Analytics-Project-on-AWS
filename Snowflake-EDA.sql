...
SELECT HOSPITAL_CODE, COUNT(*) AS CNT, COUNT(CASE_ID) AS CNT_CASES
FROM HEALTHDB.HEALTHSCHEMA.HEALTH_DATA
GROUP BY 1
ORDER BY 2 DESC;

-- Unique number of hospital type code and their distribution
SELECT HOSPITAL_TYPE_CODE, COUNT(HOSPITAL_CODE) AS CNT_HOSPITAL_CODE,COUNT(*) AS CNT, COUNT(CASE_ID) AS CNT_CASES
FROM HEALTHDB.HEALTHSCHEMA.HEALTH_DATA
GROUP BY 1
ORDER BY 2 DESC;
...
SELECT CITY_CODE_HOSPITAL, COUNT(HOSPITAL_CODE) AS CNT_HOSPITAL_CODE,
        COUNT(HOSPITAL_TYPE_CODE) AS CNT_HOSPITAL_TYPE_CODE,
        COUNT(*) AS CNT, COUNT(CASE_ID) AS CNT_CASES
FROM HEALTHDB.HEALTHSCHEMA.HEALTH_DATA
GROUP BY 1
ORDER BY 2 DESC;

-- Unique number of hospital region code and their distribution
SELECT HOSPITAL_REGION_CODE, COUNT(HOSPITAL_CODE) AS CNT_HOSPITAL_CODE,
        COUNT(HOSPITAL_TYPE_CODE) AS CNT_HOSPITAL_TYPE_CODE,
        COUNT(*) AS CNT, COUNT(CASE_ID) AS CNT_CASES
FROM HEALTHDB.HEALTHSCHEMA.HEALTH_DATA
GROUP BY 1
...
SELECT DEPARTMENT, COUNT(HOSPITAL_CODE) AS CNT_HOSPITAL_CODE,
        COUNT(HOSPITAL_TYPE_CODE) AS CNT_HOSPITAL_TYPE_CODE,
        COUNT(*) AS CNT, COUNT(CASE_ID) AS CNT_CASES
FROM HEALTHDB.HEALTHSCHEMA.HEALTH_DATA
GROUP BY 1
...
SELECT BED_GRADE, COUNT( HOSPITAL_CODE) AS CNT_HOSPITAL_CODE,
        COUNT(HOSPITAL_TYPE_CODE) AS CNT_HOSPITAL_TYPE_CODE,
        COUNT(*) AS CNT, COUNT(CASE_ID) AS CNT_CASES
FROM HEALTHDB.HEALTHSCHEMA.HEALTH_DATA
GROUP BY 1
...
SELECT TYPE_OF_ADMISSION, COUNT(HOSPITAL_CODE) AS CNT_HOSPITAL_CODE,
        COUNT(HOSPITAL_TYPE_CODE) AS CNT_HOSPITAL_TYPE_CODE,
        COUNT(*) AS CNT, COUNT(CASE_ID) AS CNT_CASES
FROM HEALTHDB.HEALTHSCHEMA.HEALTH_DATA
GROUP BY 1
...
SELECT SEVERITY_OF_ILLNESS, COUNT(HOSPITAL_CODE) AS CNT_HOSPITAL_CODE,
        COUNT(HOSPITAL_TYPE_CODE) AS CNT_HOSPITAL_TYPE_CODE,
        COUNT(*) AS CNT, COUNT(CASE_ID) AS CNT_CASES
FROM HEALTHDB.HEALTHSCHEMA.HEALTH_DATA
GROUP BY 1
...
SELECT AGE, COUNT(HOSPITAL_CODE) AS CNT_HOSPITAL_CODE,
        COUNT(HOSPITAL_TYPE_CODE) AS CNT_HOSPITAL_TYPE_CODE,
        COUNT(*) AS CNT, COUNT(CASE_ID) AS CNT_CASES
FROM HEALTHDB.HEALTHSCHEMA.HEALTH_DATA
GROUP BY 1
...
DEPARTMENT AS (
    ...
    SELECT DEPARTMENT, COUNT(CASE_ID) AS CNT_CASES
    FROM BASE 
    GROUP BY 1
